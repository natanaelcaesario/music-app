    ...
    <section class="masthead">
        <div class="cotainer p-5">
            ...
            <div class="row justify-content-center align-content-center">
                <div class="col-lg-4">
                    <h1 class="costom-title">Register Page</h1>
                    <img src="<?= base_url('assets/img/music3.svg') ?>" width="100%" class="">
                </div>
                <div class="col-md-4 ">
                        ...
                        <div class="card-body p-3">
                            <form action="" method="">
                                ...
                                <div class="d-flex col-md-12 mt-3 mb-3">
                                    ...
                                    <a href="<?= base_url('auth/login') ?>" class="btn btn-link text-decoration-none">
                                        Sudah Punya Akun?
                                    </a>
                                </div>
                            </form>
